            ...
            TbCard(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    Platform.isAndroid
                        ? 'Exports all clients and images to a .tailorbackup file in your Downloads folder.'
            ...
            TbCard(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 6),
                  Text(
                    'Recover your customer database from a .tailorbackup file.',
                    style: AppTextStyles.bodyMd(),
                  ),
                  const SizedBox(height: 12),
                  // Warning chip
              ...
              child: Column(
                ...
                children: [
                  ...
                  TbInfoRow(
                    ...
                    text:
                        'One .tailorbackup file contains all your client records and images.',
                  ),
                  const SizedBox(height: 4),
                  TbInfoRow(
                    icon: Icons.cloud_outlined,
                    text:
                        'Upload to Google Drive or WhatsApp yourself — survives factory resets.',
                  ),
                  const SizedBox(height: 4),
                  TbInfoRow(
                    icon: Icons.warning_amber_rounded,
                    text: 'Always backup before resetting your phone.',
